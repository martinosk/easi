...
- [x] Phase 3: Migrate EditCapabilityDialog to Mantine Modal (complex, with React Query hooks)
...
- [x] Phase 4: Add responsive Grid and breakpoint utilities
  - [x] Create useResponsive hook with breakpoint detection (isMobile, isTablet, isDesktop)
  - [x] Add responsive grid column configurations for each capability level
  - [x] Add responsive spacing utilities (padding, gap)
- [x] Phase 4: Enhance mobile layouts
  - [x] Update VisualizationArea with responsive Stack/Group components
  - [x] Add mobile-optimized title sizes and spacing
  - [x] Update NestedCapabilityGrid tests to use MantineTestWrapper
- [x] Phase 5: Clean up redundant CSS
  - [x] Remove unused collapsible sidebar styles from visualization.css
  - [x] Keep form/dialog styles for non-migrated components
- [x] All unit tests passing (519/519 pass)
- [x] E2E tests compatible (data-testid selectors preserved in Mantine migration)
- [x] Accessibility improved via Mantine components:
  - [x] Mantine Modal provides proper focus management, keyboard navigation, screen reader support
  - [x] Mantine form inputs have proper label associations and error announcements
  - [x] Responsive hook supports reduced motion preferences
