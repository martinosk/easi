...
**Status**: superseded by [spec 180](180_TimeAssessment_On_Realizations_done.md) — assessed TIME is recorded per capability realisation (domain capability + application), not per enterprise capability. This spec also depended on EC linking, which spec 172 removed.
