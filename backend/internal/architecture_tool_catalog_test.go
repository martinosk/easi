...
var excludedRoutes = map[string]string{
	...
	"PUT /directions/*":                           "direction edits — architect-only deliberation, reserved for human via UI",
	"POST /directions/*/advance/*":                "direction status advance — architect-only deliberation, reserved for human via UI",
	"POST /directions/*/reject":                   "direction rejection — architect-only deliberation, reserved for human via UI",
