...
var excludedRoutes = map[string]string{
	...
	"GET /components/ownership-statistics":                           "component statistics — UI stewardship tile (specs 214/215)",
	"POST /components/*/ownership/nomination":                        "ownership stewardship — reserved for UI in spec 214 slice",
	"POST /components/*/ownership/confirmation":                      "ownership stewardship — reserved for UI in spec 214 slice",
	...
	"POST /meta-model/subject-types/*/attributes":                    "metamodel write — blocked by permission ceiling",
	"PUT /meta-model/subject-types/*/attributes/*":                   "metamodel write — blocked by permission ceiling",
	"POST /meta-model/subject-types/*/attributes/*/retire":           "metamodel write — blocked by permission ceiling",
	"POST /meta-model/subject-types/*/attributes/*/reactivate":       "metamodel write — blocked by permission ceiling",
	"POST /meta-model/subject-types/*/attributes/*/options":          "metamodel write — blocked by permission ceiling",
	"POST /meta-model/subject-types/*/attributes/*/options/*/retire": "metamodel write — blocked by permission ceiling",
	"PUT /meta-model/subject-types/*/attributes/*/bounds":            "metamodel write — blocked by permission ceiling",
