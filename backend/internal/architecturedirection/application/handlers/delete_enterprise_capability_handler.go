...
func NewDeleteEnterpriseCapabilityHandler(repository DeleteCapabilityRepository) *DeleteEnterpriseCapabilityHandler {
	return &DeleteEnterpriseCapabilityHandler{repository: repository}
}
