...
type SubjectAuditAdapter struct {
	db *database.TenantAwareDB
}

func NewSubjectAuditAdapter(db *database.TenantAwareDB) ports.SubjectAuditReader {
	return SubjectAuditAdapter{db: db}
}

func (a SubjectAuditAdapter) Created(ctx context.Context, aggregateID string) (ports.SubjectAudit, error) {
