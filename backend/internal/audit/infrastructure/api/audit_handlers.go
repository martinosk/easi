...
type AuditHistoryResponse struct {
	Entries    []readmodels.AuditEntry `json:"entries"`
...
type AuditHandlers struct {
	readModel *readmodels.AuditHistoryReadModel
	hateoas   *AuditLinks
}

func NewAuditHandlers(readModel *readmodels.AuditHistoryReadModel, hateoas *AuditLinks) *AuditHandlers {
