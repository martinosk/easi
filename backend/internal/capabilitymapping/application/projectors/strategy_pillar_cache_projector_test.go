...
type cmStrategyPillarCacheReadModelForProjector interface {
...
type testableCMStrategyPillarCacheProjector struct {
	readModel cmStrategyPillarCacheReadModelForProjector
}

func newTestableCMStrategyPillarCacheProjector(readModel cmStrategyPillarCacheReadModelForProjector) *testableCMStrategyPillarCacheProjector {
	return &testableCMStrategyPillarCacheProjector{readModel: readModel}
}

func (p *testableCMStrategyPillarCacheProjector) ProjectEvent(ctx context.Context, eventType string, eventData []byte) error {
...
func (p *testableCMStrategyPillarCacheProjector) handleConfigurationCreated(ctx context.Context, eventData []byte) error {
...
func (p *testableCMStrategyPillarCacheProjector) handlePillarAdded(ctx context.Context, eventData []byte) error {
...
func (p *testableCMStrategyPillarCacheProjector) handlePillarUpdated(ctx context.Context, eventData []byte) error {
...
func (p *testableCMStrategyPillarCacheProjector) handlePillarRemoved(ctx context.Context, eventData []byte) error {
...
func (p *testableCMStrategyPillarCacheProjector) handleFitConfigurationUpdated(ctx context.Context, eventData []byte) error {
	return p.unmarshalAndUpdate(ctx, eventData, func(event pillarEvent, existing *readmodels.StrategyPillarCacheDTO) {
...
func (p *testableCMStrategyPillarCacheProjector) unmarshalAndUpdate(ctx context.Context, eventData []byte, mutate func(pillarEvent, *readmodels.StrategyPillarCacheDTO)) error {
	var event pillarEvent
	if err := json.Unmarshal(eventData, &event); err != nil {
		return err
	}
...
func TestStrategyPillarCacheProjector_ConfigurationCreated_InsertsAllPillars(t *testing.T) {
	...
	projector := newTestableCMStrategyPillarCacheProjector(mock)
...
func TestStrategyPillarCacheProjector_ErrorPropagation(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			projector := newTestableCMStrategyPillarCacheProjector(tt.mock)
