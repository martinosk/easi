...
func capabilityTools() []agenttools.AgentToolSpec {
	return []agenttools.AgentToolSpec{
		{
			...
			QueryParams: []agenttools.ParamSpec{
				agenttools.StringParam("name", "Filter by capability name (partial match)", false),
		...
		},
		{
			...
			PathParams: []agenttools.ParamSpec{agenttools.UUIDParam("id", "Capability ID (UUID)")},
		},
		{
			...
			Access: agenttools.AccessCreate, Permission: "capabilities:write",
			Method: "POST", Path: "/capabilities",
			BodyParams: []agenttools.ParamSpec{
				agenttools.StringParam("name", "Capability name", true),
				agenttools.StringParam("level", "Hierarchy level: L1 (no parent), L2 (parent is L1), L3 (parent is L2), or L4 (parent is L3)", true),
				agenttools.StringParam("parentId", "Parent capability ID (UUID). Required for L2/L3/L4, omit for L1.", false),
				agenttools.StringParam("description", "Capability description", false),
			},
		},
		{
			...
			Access: agenttools.AccessUpdate, Permission: "capabilities:write",
			Method: "PUT", Path: "/capabilities/{id}",
			PathParams: []agenttools.ParamSpec{agenttools.UUIDParam("id", "Capability ID (UUID)")},
			BodyParams: []agenttools.ParamSpec{
				agenttools.StringParam("name", "New capability name", false),
				agenttools.StringParam("description", "New capability description", false),
			},
		},
		{
			...
			Access: agenttools.AccessDelete, Permission: "capabilities:write",
		...
		},
		{
			...
			BodyParams: []agenttools.ParamSpec{
				...
				agenttools.StringParam("realizationLevel", "Realization level: Full, Partial, or Planned", false),
			},
		},
		{
			...
			PathParams: []agenttools.ParamSpec{agenttools.UUIDParam("id", "Realization ID (UUID)")},
		},
	}
}

func capabilityMetadataTools() []agenttools.AgentToolSpec {
	return []agenttools.AgentToolSpec{
		{
		...
		},
		{
			...
			PathParams: []agenttools.ParamSpec{agenttools.UUIDParam("id", "Capability ID (UUID)")},
			BodyParams: []agenttools.ParamSpec{
				agenttools.StringParam("status", "Capability status (e.g. Active, Planned, Retiring)", true),
				agenttools.StringParam("maturityLevel", "Maturity level name", false),
				agenttools.StringParam("ownershipModel", "Ownership model (e.g. Centralized, Federated)", false),
				agenttools.StringParam("primaryOwner", "Primary owner name", false),
				agenttools.StringParam("eaOwner", "EA owner: a user ID, or a user name/email that matches exactly one user", false),
			},
		},
		{
		...
		},
		{
			...
			Access: agenttools.AccessRead, Permission: "domains:read",
			Method: "GET", Path: "/business-domains/{id}/importance",
			PathParams: []agenttools.ParamSpec{agenttools.UUIDParam("id", "Business domain ID (UUID)")},
		},
		{
...
func businessDomainTools() []agenttools.AgentToolSpec {
	return []agenttools.AgentToolSpec{
		{
		...
		},
		{
			...
			Access: agenttools.AccessCreate, Permission: "domains:write",
			Method: "POST", Path: "/business-domains",
			BodyParams: []agenttools.ParamSpec{
				agenttools.StringParam("name", "Business domain name", true),
				agenttools.StringParam("description", "Business domain description", false),
			},
		},
		{
			...
			Access: agenttools.AccessUpdate, Permission: "domains:write",
			Method: "PUT", Path: "/business-domains/{id}",
			PathParams: []agenttools.ParamSpec{agenttools.UUIDParam("id", "Business domain ID (UUID)")},
			BodyParams: []agenttools.ParamSpec{
				agenttools.StringParam("name", "New business domain name", false),
				agenttools.StringParam("description", "New business domain description", false),
			},
		},
		{
			...
			PathParams: []agenttools.ParamSpec{agenttools.UUIDParam("domainId", "Business domain ID (UUID)")},
			BodyParams: []agenttools.ParamSpec{
		...
		},
		{
			...
			Access: agenttools.AccessDelete, Permission: "domains:write",
			Method: "DELETE", Path: "/business-domains/{domainId}/capabilities/{capabilityId}",
			PathParams: []agenttools.ParamSpec{
				agenttools.UUIDParam("domainId", "Business domain ID (UUID)"),
				agenttools.UUIDParam("capabilityId", "Capability ID (UUID)"),
			},
		},
	}
}

func dependencyTools() []agenttools.AgentToolSpec {
	return []agenttools.AgentToolSpec{
		{
		...
		},
		{
			...
			BodyParams: []agenttools.ParamSpec{
				...
				agenttools.StringParam("description", "Dependency description", false),
			},
		},
		{
			...
			PathParams: []agenttools.ParamSpec{agenttools.UUIDParam("id", "Dependency ID (UUID)")},
		},
		{
			...
			PathParams: []agenttools.ParamSpec{agenttools.UUIDParam("id", "Parent capability ID (UUID)")},
		},
	}
}

func domainCapabilityRealizationTools() []agenttools.AgentToolSpec {
	return []agenttools.AgentToolSpec{
		{
			...
			PathParams: []agenttools.ParamSpec{agenttools.UUIDParam("id", "Business domain ID (UUID)")},
			QueryParams: []agenttools.ParamSpec{
				agenttools.IntParam("depth", "Maximum capability hierarchy depth to include (1–4, default 4)"),
			},
		},
	}
}

func strategyTools() []agenttools.AgentToolSpec {
	return []agenttools.AgentToolSpec{
		{
		...
		},
		{
			...
			PathParams: []agenttools.ParamSpec{
				agenttools.UUIDParam("id", "Business domain ID (UUID)"),
				agenttools.UUIDParam("capabilityId", "Capability ID (UUID)"),
			},
			BodyParams: []agenttools.ParamSpec{
		...
		},
		{
			...
			PathParams: []agenttools.ParamSpec{agenttools.UUIDParam("id", "Application component ID (UUID)")},
		},
		{
			...
			PathParams: []agenttools.ParamSpec{
				agenttools.UUIDParam("id", "Application component ID (UUID)"),
				agenttools.UUIDParam("pillarId", "Strategy pillar ID (UUID)"),
			},
			BodyParams: []agenttools.ParamSpec{
				agenttools.IntParam("score", "Fit score value (higher = better fit)"),
			},
		},
		{
