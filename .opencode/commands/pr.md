...
Run the full quality pipeline, then open a pull request.
...
6. If all steps pass, create a pull request with a clear title and description summarising the changes.
7. If any step fails, fix the issue and re-run that step before proceeding.
