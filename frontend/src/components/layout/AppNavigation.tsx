  ...
  return (
    <nav className="app-header-nav">
      ...
      <button
        ...
        onClick={() => onNavigate('business-domains')}
      ...
      {canViewEnterpriseArch && (
        <button
          ...
          onClick={() => onNavigate('enterprise-architecture')}
      ...
      {canManageMetaModel && (
        <button
          type="button"
          className={`app-header-nav-item ${currentView === 'settings' ? 'app-header-nav-item-active' : ''}`}
