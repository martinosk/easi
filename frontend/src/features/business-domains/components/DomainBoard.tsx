...
export function DomainBoard({ hookData }: DomainBoardProps) {
  ...
  const showRail = hookData.showAssignRail && hookData.assignRailOpen;
                ...
                >
                  <DomainBoardCard
                    ...
                    onCapabilityContextMenu={(capability, event) =>
                      hookData.capabilityContextMenu.handleCapabilityContextMenu(viewModel.domain.id, capability, event)
                    }
