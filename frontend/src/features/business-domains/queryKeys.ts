export const businessDomainsQueryKeys = {
  ...
  list: (filters?: Record<string, unknown>) => [...businessDomainsQueryKeys.lists(), filters] as const,
  ...
  capabilitiesByLink: (link: string) => [...businessDomainsQueryKeys.all, 'capabilitiesByLink', link] as const,
...
export const strategyImportanceQueryKeys = {
  ...
  byDomain: (domainId: string) => [...strategyImportanceQueryKeys.all, 'byDomain', domainId] as const,
  byCapability: (capabilityId: string) => [...strategyImportanceQueryKeys.all, 'byCapability', capabilityId] as const,
};
