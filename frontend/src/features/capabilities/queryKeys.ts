export const capabilitiesQueryKeys = {
  ...
  list: (filters?: Record<string, unknown>) => [...capabilitiesQueryKeys.lists(), filters] as const,
  ...
  byComponent: (componentId: string) => [...capabilitiesQueryKeys.all, 'byComponent', componentId] as const,
