...
import classes from './StrategicFitPage.module.css';
...
export function StrategicFitPage() {
  return (
    <div className={classes.page} data-testid="strategic-fit-page">
