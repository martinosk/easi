...
import type { InviteTarget, OriginEntityContextMenuState } from '../hooks/useTreeContextMenus';
...
export const NavigationTreeDialogs: React.FC<NavigationTreeDialogsProps> = ({
  ...
  return (
    <>
      ...
      <CreateAcquiredEntityDialog isOpen={openOriginDialog === 'acquired'} onClose={onCloseOriginDialog} />

      <CreateVendorDialog isOpen={openOriginDialog === 'vendor'} onClose={onCloseOriginDialog} />

      <CreateInternalTeamDialog isOpen={openOriginDialog === 'team'} onClose={onCloseOriginDialog} />
