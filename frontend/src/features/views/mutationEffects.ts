...
export const viewsMutationEffects = {
  ...
  rename: (viewId: string) => [viewsQueryKeys.lists(), viewsQueryKeys.detail(viewId)],

  setDefault: () => [viewsQueryKeys.lists()],

  changeVisibility: (viewId: string) => [viewsQueryKeys.lists(), viewsQueryKeys.detail(viewId)],

  updateDetail: (viewId: string) => [viewsQueryKeys.detail(viewId)],
};
